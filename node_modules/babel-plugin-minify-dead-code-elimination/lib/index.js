...
module.exports = function (_ref) {
  ...
  var main = {
        ...
        var _loop3 = function _loop3(name) {
          ...
          if (!binding.referenced && binding.kind !== "param" && binding.kind !== "module") {
            var _ret4 = function () {
              ...
              if (binding.path.isVariableDeclarator() && binding.path.node.init && !scope.isPure(binding.path.node.init)) {
    ...
    ReturnStatement: function ReturnStatement(path) {
      ...
      if (path.container.length - 1 !== path.key && !path.getSibling(path.key + 1).isFunctionDeclaration() && path.parentPath.isBlockStatement()) {
